...
type GoCode struct {
	...
	EmitEmbedAlias              bool     `protobuf:"varint,28,opt,name=emit_embed_alias,json=emitEmbedAlias,proto3" json:"emit_embed_alias,omitempty"`
}
...
func (x *GoCode) GetEmitEmbedAlias() bool {
	if x != nil {
		return x.EmitEmbedAlias
	}
	return false
}
...
var file_plugin_codegen_proto_rawDesc = []byte{
	...
	0x72, 0x75, 0x63, 0x74, 0x73, 0x12, 0x28, 0x0a, 0x10, 0x65, 0x6d, 0x69, 0x74, 0x5f, 0x65, 0x6d,
	0x62, 0x65, 0x64, 0x5f, 0x61, 0x6c, 0x69, 0x61, 0x73, 0x18, 0x1c, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x0e, 0x65, 0x6d, 0x69, 0x74, 0x45, 0x6d, 0x62, 0x65, 0x64, 0x41, 0x6c, 0x69, 0x61, 0x73, 0x42,
